...
def mock_test_get_public_transport_connection(monkeypatch):
    monkeypatch.setattr(search_ch_service, 'get_connection',
                        lambda start, destination, departure:
                        _mock_test_get_public_transport_connection_get_connection(start, destination))
    monkeypatch.setattr(overpass_service, 'get_connection_coordinates',
                        ...
                        _mock_test_get_public_transport_connection_get_connection_coordinates(start_uic_ref, line))


def _mock_test_get_public_transport_connection_get_connection(start, destination):
    response_file = None
...
def _mock_test_get_public_transport_connection_get_connection_coordinates(start_uic_ref, line):
    # Test: test_get_public_transport_connection_single_leg
